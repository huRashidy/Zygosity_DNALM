...
# ------------------ Main plotting ------------------
for chr_num in chrs:
    csv_path = f"/data/horse/ws/huel099f-ancestry_task/results/results_chr{chr_num}_XGB_all_types_filtering_True_var1e-05_corr1_xgbparams.csv"
    out_pdf = f"/data/horse/ws/huel099f-ancestry_task/figures/for_thesis/chr{chr_num}_XGB_True_var1e-05_corr1_xgbparams.pdf"
    out_png = f"/data/horse/ws/huel099f-ancestry_task/figures/for_pres/chr{chr_num}_XGB_True_var1e-05_corr1_xgbparams.png"
